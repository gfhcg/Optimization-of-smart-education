...
import teachers from '@/pages/Student/Leader/teachers'
  ...
  return (
    <div>
      <div className={styles['detail-container']}>
        ...
        <div className={styles['search-container']}>  <Searchs ></Searchs></div>
        <ul className={styles['teacher-container']}>
          <li id='0' onClick={() => navigate('/student/leader/leaderinfo')}>
        ...
        <div className={styles['pagination-container']}> <Paginations getCurrent={getCurrentPage}></Paginations></div>
      </div>
    </div>
