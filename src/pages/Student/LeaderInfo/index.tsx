...
const Description: React.FC = () => (
    <Descriptions title="" layout="vertical" bordered size='default'>
        <Descriptions.Item label=""><img src='src/assets/pic/teachersimg/1.jpg' className={styles['img-container']}></img></Descriptions.Item>
        ...
        <Descriptions.Item label="所在科研团队简介" span={3}>
            ...
            实验室现有固定成员12人，其中教授2人，副教授4人，讲师6人，近 60%固定成员在国外获得博士学位，硕士研究生100余人。实验室服务大数据、人工智能等国家重大战略需求，紧密对接成渝地区双城经济圈建设和产业转型升级，培养适应和引领新一轮科技革命和产业变革挑战，能够把自身价值实现与国家发展紧密联系，具备家国情怀的卓越工程科技人才。近3年来，实验室培养的硕士研究生50%以上就职于阿里巴巴、腾讯、百度、字节跳动、华为等企业的数据挖掘、机器学习、推荐算法工程师岗位。
    ...
    return (
        <div>
            <div className={styles['detail-container']}>
                <div className={styles['des-container']}> <Description></Description></div>
